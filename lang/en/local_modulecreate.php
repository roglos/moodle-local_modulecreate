...
$string['remotetablewrite'] = 'Remote table to write results to';
$string['remotetablewrite_desc'] = 'Specify of the name of the table to be written to. ';
$string['remotetablecat'] = 'Categories remote table';
$string['remotetablecat_desc'] = 'Remote table to retrieve categories from';
$string['remotetablecourses'] = 'Module remote table';
$string['remotetablecourses_desc'] = 'Remote table to retrieve module details from';
$string['remotetableenrols'] = 'Remote enrolments table';
$string['remotetableenrols_desc'] = 'Remote table to retrieve module enrolments from';
